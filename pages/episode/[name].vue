<template>
    <body
        class="episode-template-default single single-episode postid-201913 wp-custom-logo wp-embed-responsive masvideos masvideos-page masvideos-single masvideos-js single-episode-v3 full-width dark ">
                ...
                <div class="container">
                    <div class="site-content__inner">
                        <div id="primary" class="content-area">
                            <div id="episode-201913" class="post-201913 episode type-episode status-publish hentry">
                                ...
                                <div class="single-episode__content column">
                                    ...
                                    <div class="single-episode__row row">
                                        <div class="single-episode__sidebar column1 single-episode-custom">
                                                    ...
                                                    <div class="tv-show__info">
                                                        <div class="tv-show__info--head"><span
                                                            ...
                                                            <div class="episode__description">
                                                                <div style="height: 47px; max-height: none;"
                                                                    data-readmore="" aria-expanded="false" id="rmjs-1">
                                                                    <!-- wp:paragraph -->
                                                                    <p>두바이에서 런던으로 가는 KA29편이 7시간의 비행 도중 공중 납치되자, 뛰어난 기업 전문
                                                                        교섭자인 샘 넬슨은 자신의 전문적 지식을 이용해 탑승객 전원을 구하려 한다. 이런 위험한
                                                                        전략은 오히려 샘의 약점이 되고 말 것인가?</p>
                                                                    <!-- /wp:paragraph -->
                                                                </div><a class="maxlist-more" href="#"
                                                                    data-readmore-toggle="rmjs-1" aria-controls="rmjs-1">더
                                                                    보기</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div style="margin-bottom:15px;">
                                                <a href="https://justlink.tv/안동맛집-숯불갈비-전문-동부한우갈비?pid=201913"
                                                    link="https://justlink.tv/안동맛집-숯불갈비-전문-동부한우갈비" pid="201913"
                                                    class="a_btn_out">
                                                    <button class="btn-outlink">바로보기</button>
                                                </a>
                                            </div>
                                            <!--  <div style="margin-bottom:15px;"> <a href="" link="" pid="201913" class="a_btn_out"> <button class="btn-outlink">바로보기</button> </a> </div> -->
                                        </div>
                                    ...
                                    <div class="masvideos-tabs episode-tabs">
                                        <ul class="nav" pos="0">
                                            <li class="nav-item">
                                                <a href="#tab-64d5ddc8cd0f4description" data-toggle="tab"
                                                    class="nav-link active show">
                                                    정보 </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="#tab-64d5ddc8cd0f4reviews" data-toggle="tab" class="nav-link">
                                                    댓글 </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            <div id="tab-64d5ddc8cd0f4description" class="tab-pane active show">
                                                <div class="episode__description">
                                                    <div><!-- wp:paragraph -->
                                                        <p>두바이에서 런던으로 가는 KA29편이 7시간의 비행 도중 공중 납치되자, 뛰어난 기업 전문 교섭자인 샘 넬슨은 자신의
                                                            전문적 지식을 이용해 탑승객 전원을 구하려 한다. 이런 위험한 전략은 오히려 샘의 약점이 되고 말 것인가?</p>
                                                        <!-- /wp:paragraph -->
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="tab-64d5ddc8cd0f4reviews" class="tab-pane">
                                                <div id="reviews" class="masvideos-Reviews">
                                                    <div id="review_form_wrapper">
                                                        <div id="review_form">
                                                            <div id="respond" class="comment-respond">
                                                                <span id="reply-title" class="comment-reply-title">“하이재킹 7화”
                                                                    의 첫 댓글을 남겨주세요 <small><a rel="nofollow"
                                                                ...
                                                                <form action="/wp-comments-post.php"
                                                                    ...
                                                                    <p class="comment-notes"><span id="email-notes">이메일 주소는
                                                                            ...
                                                                            aria-hidden="true">필수 필드는 <span class="required"
                                                                                aria-hidden="true">*</span>로 표시됩니다</span>
                                                                    </p>
                                                                    <p class="comment-form-comment"><label for="comment">댓글
                                                                            남기기&nbsp;<span
                                                                ...
                                                                <p class="comment-form-cookies-consent"><input
                                                                        ...
                                                                        for="wp-comment-cookies-consent">다음 번 댓글 작성을 위해
                                                                        이 브라우저에 이름, 이메일, 그리고 웹사이트를 저장합니다.</label></p>
                                                                <p class="form-submit"><input name="submit"
                                                                        type="submit" id="submit" class="submit"
                                                                        value="등록"> <input type="hidden"
                                                                        name="comment_post_ID" value="201913"
                                                                        id="comment_post_ID">
                                                ...
                                                <div id="comments">
                                                    <p class="masvideos-noreviews">현재 작성된 댓글이 없습니다</p>
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                        </div>
                                ...
                                <div style="text-align: center;margin-top: 15px;" class="ads-bottom-episode"></div>
                            </div>
                            <div class="single-episode__sidebar column1 sidebar_episode ">
                                <div class="vodi-single-episode__sidebar--seasons-episode custom-sidebar-ep">
                                    ...
                                    <div class="masvideos-tabs">
                                        <ul class="nav" pos="0">
                                            <li class="nav-item">
                                                <a href="#tab-64d5ddc8d3bbf0" data-toggle="tab"
                                                    class="nav-link active show">
                                                    <h3 class="season-title">시즌 1</h3><span
                                                        class="episodes-count">7</span>
                                                </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content">
                                            <div id="tab-64d5ddc8d3bbf0" class="tab-pane active show">
                                                <h3 class="vodi-single-episode__sidebar--seasons-episode__season-title">
                                                    지난회차 - 시즌 1</h3>
                                        ...
                                        data-readmore-toggle="rmjs-1" aria-controls="rmjs-1">더 보기</a>
                                </div>
                                        ...
                                        <form method="post" class="masvideos-form masvideos-form-register register">
                                            ...
                                            <p class="masvideos-FormRow form-row">
                                                <input type="hidden" id="masvideos-register-nonce"
                                                    name="masvideos-register-nonce" value="16b28ee1d8"><input
                                                    type="hidden" name="_wp_http_referer"
                                                    value="/episode/%ed%95%98%ec%9d%b4%ec%9e%ac%ed%82%b9-7%ed%99%94/">
                                        ...
                                        <form class="masvideos-form masvideos-form-login login" method="post">
                                            ...
                                            <p class="form-row">
                                                <input type="hidden" id="masvideos-login-nonce"
                                                    name="masvideos-login-nonce" value="6530e7bd46"><input type="hidden"
