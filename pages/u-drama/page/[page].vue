<script setup>
    ...
    let { pending, data } = await useFetch('http://38.60.146.22/api/tvshows', {
        query: {
            page: page,
            orderBy: orderBy,
            type: 'u-drama'
    ...
    <body
        ...
        <div id="page" class="hfeed site">
            ...
            <div id="content" class="site-content " tabindex="-1">
                <div class="container">
                    <TvshowsBreadScrumb base="/u-drama" title="미드" :page="page" />
                    <div class="site-content__inner">
                        <div id="primary" class="content-area"> <!-- ads tv-show top -->
                            ...
                            <Pagination base="/u-drama" :perPage="data.perPage" :currentPage="page" :total="data.total" :orderBy="orderBy" />
                        </div><!-- /.content-area -->
                        <div id="secondary" class="widget-area sidebar-area tv-show-sidebar sidebar-custom" role="complementary">
                            <TvshowsPopularContents v-if="data" title="주간 미드 인기컨텐츠" :data="data.data.top5" />
                        </div><!-- #secondary -->
