<script setup>
    ...
    let { data } = await useFetch('https://backendnew.takitv.net/api/tvshows', {
        query: {
            genre: genre,
            orderBy: orderBy,
            page: page
    ...
    <body
        ...
        <div id="page" class="hfeed site">
            ...
            <div id="content" class="site-content " tabindex="-1">
                <div class="container">
                    <TvshowsBreadScrumb :page="page" :base="'/tv-show-genre/' + genre" :title="genre" />
                    <div class="site-content__inner">
                        <div id="primary" class="content-area"> <!-- ads tv-show top -->
                            ...
                            <Pagination v-if="data && data.total > data.perPage" :base="'/tv-show-genre/' + genre" :perPage="data.perPage" :currentPage="1" :total="data.total" />
                        </div><!-- /.content-area -->
