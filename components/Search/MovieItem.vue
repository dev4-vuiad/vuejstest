...
<template>
    <div v-if="postType == 'tv_show'" class="tv-show  tv_show type-tv_show status-publish has-post-thumbnail hentry ">  
        ...
        <div class="tv-show__poster box-phim loading-bg">
                <NuxtLink :to="'/episode/' + slug" class="masvideos-LoopTvShow-link masvideos-loop-tv-show__link tv-show__link">
                    <img :src="src" class="tv-show__poster--image tv_show__poster--image lazyload" :key="renderCount">		                                                     
    ...
    <div v-else class="movie type-movie status-publish has-post-thumbnail hentry" :postid="id">
        <div class="movie__poster box-phim">
            <NuxtLink :to="'/movie/' + slug" class="masvideos-LoopMovie-link masvideos-loop-movie__link movie__link">
                <img :src="src" :srcset="srcSet" class="movie__poster--image lazyload" :key="renderCount">
            </NuxtLink>
