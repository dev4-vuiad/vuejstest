<script setup>
    ...
    onMounted(() => {
        ...
        const wrap = document.querySelector('.embla.k-sisa');
        if (wrap) {
            ...
            jQuery(document).ready(function () {
                var wr = jQuery('.embla.k-sisa .embla__slide__inner').width();
                if (wr < 220) {
                    jQuery('.embla.k-sisa .embla__slide__img').each(function () {
