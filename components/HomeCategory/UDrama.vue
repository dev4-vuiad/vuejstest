<script setup>
    ...
    onMounted(() => {
        ...
        const wrap = document.querySelector('.embla.u-drama');
        if (wrap) {
            ...
            jQuery(document).ready(function () {
                var wr = jQuery('.embla.u-drama .embla__slide__inner').width();
                if (wr < 220) {
                    jQuery('.embla.u-drama .embla__slide__img').each(function () {
                        ...
                        <div class="tv-show__info">
                            <div class="tv-show__info--head">
                                ...
                                <NuxtLink :to="'/episode/' + item.slug"
                                    class="masvideos-LoopTvShow-link masvideos-loop-tv-show__link tv-show__link"><span class="span_sea_ep_title">{{ $getEpTxt(item.seasonNumber, item.episodeNumber) }}</span>
