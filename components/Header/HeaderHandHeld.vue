        ...
        <div class="container-fluid">
            <div class="site-header__inner">
                <div class="site-header__left">
                                                ...
                                                <div class="site_header__offcanvas-nav">
                                                    <ul id="menu-main-menu-2" class="offcanvas-nav yamm">
                                                        <li itemscope="itemscope"
                                                            ...
                                                            class="menu-item menu-item-type-post_type menu-item-object-page nav-item show">
                                                        ...
                                                        <li itemscope="itemscope"
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li itemscope="itemscope"
                                                                    itemtype="https://www.schema.org/SiteNavigationElement"
                                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category nav-item show">
                                                                    <NuxtLink title="드라마" to="/k-drama/"
                                                                        class="dropdown-item show">드라마</NuxtLink>
                                                                </li>
                                                                <li itemscope="itemscope"
                                                                    itemtype="https://www.schema.org/SiteNavigationElement"
                                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category nav-item show">
                                                                    <NuxtLink title="예능" to="/k-show/"
                                                                        class="dropdown-item show">예능</NuxtLink>
                                                                </li>
                                                                <li itemscope="itemscope"
                                                                    itemtype="https://www.schema.org/SiteNavigationElement"
                                                                    class="menu-item menu-item-type-taxonomy menu-item-object-category nav-item show">
                                                                    <NuxtLink title="시사다큐" to="/k-sisa/"
                                                                        class="dropdown-item show">시사</NuxtLink>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li itemscope="itemscope"
                                                            itemtype="https://www.schema.org/SiteNavigationElement"
                                                            class="menu-item menu-item-type-taxonomy menu-item-object-category nav-item show">
                                                            <NuxtLink title="미드" to="/u-drama/" class="nav-link show">미드</NuxtLink>
                                                        </li>
                                                        <li itemscope="itemscope"
                                                            itemtype="https://www.schema.org/SiteNavigationElement"
                                                            class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children dropdown nav-item show">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                <li class="menu-item" itemscope="itemscope">
                    ...
                    <div class="site-header__logo"><NuxtLink to="/" class="custom-logo-link" rel="home" aria-current="page"><img
                                ...
                                sizes="(max-width: 653px) 100vw, 653px"></NuxtLink></div>
                </div><!-- /.site-header__left -->
                <div class="site-header__right">
                    <div class="ader_site-he_search">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" @click.prevent="onClickSearchBtn"><svg
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <form role="search" method="get"
                                        class="search-form masvideos-search masvideos-search-tv_show" action="/search">
