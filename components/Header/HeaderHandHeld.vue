                ...
                <div class="site-header__right">
                    ...
                    <div class="site-header__user-account dropdown">
                        ...
                        <ul class="dropdown-menu sub-menu">
                            <li><a href="/my-account/" data-toggle="modal" data-target="#modal-register-login">로그인</a></li>
                            <li><a href="/my-account/" data-toggle="modal" data-target="#modal-register-login">회원가입</a></li>
                        </ul>
                    </div>
